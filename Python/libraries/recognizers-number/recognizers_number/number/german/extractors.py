        ...
        self.__regexes = [
            ReVal(
                re=RegExpUtility.get_safe_reg_exp(
                    GermanNumeric.NumbersWithPlaceHolder(placeholder), regex.I),
                val='IntegerNum'),
            ReVal(
                re=RegExpUtility.get_safe_reg_exp(
            ...
            ReVal(
                ...
                val=f'Integer{GermanNumeric.LangMarker}'),
            ReVal(
                re=RegExpUtility.get_safe_reg_exp(
...
class GermanDoubleExtractor(BaseNumberExtractor):
    ...
    def __init__(self, placeholder):
        self.__regexes = [
            ...
            ReVal(
                re=RegExpUtility.get_safe_reg_exp(
                    GermanNumeric.DoubleWithMultiplierRegex),
                val='DoubleNum'),
            ReVal(
                re=RegExpUtility.get_safe_reg_exp(
            ...
            ReVal(
                ...
                val=f'Double{GermanNumeric.LangMarker}'),
            ReVal(
                re=RegExpUtility.get_safe_reg_exp(
    ...
    def __init__(self, mode):
        self.__regexes = [
            ...
            ReVal(
                ...
                val=f'Frac{GermanNumeric.LangMarker}'),
            ReVal(
                re=RegExpUtility.get_safe_reg_exp(
...
class GermanOrdinalExtractor(BaseNumberExtractor):
    ...
    def __init__(self):
        self.__regexes = [
            ReVal(
                re=RegExpUtility.get_safe_reg_exp(
                    GermanNumeric.OrdinalSuffixRegex),
                val='OrdinalNum'),
            ReVal(
                re=RegExpUtility.get_safe_reg_exp(
                    GermanNumeric.OrdinalGermanRegex),
                val=f'Ord{GermanNumeric.LangMarker}')
        ]
