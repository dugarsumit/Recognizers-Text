...
class GermanDateExtractorConfiguration(DateExtractorConfiguration):
    ...
    def __init__(self):
        ...
        if GermanDateTime.DefaultLanguageFallback == Constants.DEFAULT_LANGUAGE_FALLBACK_DMY:
            ...
            date_extractor_6 = GermanDateTime.DateExtractor8
            date_extractor_8 = GermanDateTime.DateExtractor6
            date_extractor_7 = GermanDateTime.DateExtractor9
            date_extractor_9 = GermanDateTime.DateExtractor7
        else:
            ...
            date_extractor_8 = GermanDateTime.DateExtractor8
            date_extractor_7 = GermanDateTime.DateExtractor7
            date_extractor_9 = GermanDateTime.DateExtractor9
        ...
        self._implicit_date_list = [
            ...
            RegExpUtility.get_safe_reg_exp(GermanDateTime.WeekDayRegex),
