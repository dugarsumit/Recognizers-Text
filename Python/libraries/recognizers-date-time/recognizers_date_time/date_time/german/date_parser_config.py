...
class GermanDateParserConfiguration(DateParserConfiguration):
    ...
    # If the German date parser need the same regexes, they should be extracted
    ...
    def __init__(self, config: BaseDateParserConfiguration):
        ...
        self._date_regex = (
            GermanDateExtractorConfiguration()).date_regex_list
    ...
    def get_swift_month(self, source: str) -> int:
        ...
        if regex.search(GermanDateParserConfiguration._next_prefix_regex, trimmed_text):
            swift = 1

        if regex.search(GermanDateParserConfiguration._past_prefix_regex, trimmed_text):
            swift = -1
